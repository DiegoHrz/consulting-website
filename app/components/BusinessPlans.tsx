...
const BusinessPlans = () => {
  const businessPlansText = {
    de: {
      title: "Verlässlichkeit, Erfahrung und echtes Engagement – wir begleiten dich auf deinem Weg",
      items: [
        {
          title: "100% Erfolgsrate",
          description: "Jeder einzelne Antrag auf Gründerzuschuss unserer Kunden wurde genehmigt."
        },
        {
          title: "Kostenlose Beratung",
          description: "Buche ein unverbindliches Erstberatungsgespräch mit uns."
        },
        {
          title: "+100 zufriedene Kunden",
          description: "Wir haben bereits zahlreiche Kunden bundesweit betreut."
        }
      ]
    },
    en: {
      title: "Reliability, experience and genuine commitment - we accompany you on your journey",
      items: [
        {
        ...
        },
        {
          ...
          description: "We have already supported numerous customers nationwide."
        }
      ]
    }
  };
