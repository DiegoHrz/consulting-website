...
const About = () => {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-800 to-indigo-900 text-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Über uns</h1>
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">AS Vision Partners</h2>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div className="bg-indigo-50 rounded-xl p-8 shadow-md">
            ...
            <blockquote className="text-gray-700 italic text-lg leading-relaxed">
              „Wir begleiten Menschen auf ihrem Weg in die Selbstständigkeit und helfen ihnen, ihre beruflichen Visionen in die Realität umzusetzen. Mit persönlicher Beratung, fachlicher Expertise und individuellen Lösungen bieten wir unseren Kund*innen die Unterstützung, die sie für eine erfolgreiche Zukunft brauchen.
            </blockquote>
          </div>
          
          <div className="bg-blue-50 rounded-xl p-8 shadow-md">
            <h3 className="text-2xl font-bold text-blue-800 mb-6">Unsere Vision</h3>
            <blockquote className="text-gray-700 italic text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-md text-center">
              ...
              <h4 className="text-xl font-semibold mb-3 text-gray-800">Maßgeschneiderte Beratung</h4>
              <p className="text-gray-600">Passend zu dir und deiner Vision.</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md text-center">
              ...
              <h4 className="text-xl font-semibold mb-3 text-gray-800">Engagiertes Team</h4>
              <p className="text-gray-600">Fachwissen und Erfahrung an deiner Seite.</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md text-center">
              ...
              <h4 className="text-xl font-semibold mb-3 text-gray-800">Klare Strategie</h4>
              <p className="text-gray-600">Für ein Unternehmen, das auf das nächste Level wächst.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/3">
              <div className="bg-gray-200 rounded-xl overflow-hidden aspect-square w-full max-w-md mx-auto">
                ...
                <div className="w-full h-full bg-gradient-to-br from-blue-200 to-indigo-300 flex items-center justify-center text-gray-500">
            ...
            <div className="md:w-2/3">
              ...
              <div className="mt-8">
                <h4 className="text-xl font-semibold mb-4 text-gray-800">Werte, die mich antreiben:</h4>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-gray-700 font-medium">Freiheit durch Selbstständigkeit:</p>
                      <p className="text-gray-600">Mein Ziel ist es, Menschen die Möglichkeit zu geben, ihr Leben selbstbestimmt zu gestalten, indem sie ihr eigenes Business erfolgreich umsetzen. Freiheit bedeutet für mich, die Kontrolle über die eigene berufliche und private Zukunft zu haben.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-gray-700 font-medium">Gesundheit und Zufriedenheit im Beruf:</p>
                      <p className="text-gray-600">Eine bewusste und gesunde Lebensweise liegt mir am Herzen, denn sie ist die Grundlage für nachhaltigen Erfolg. Dabei ist vor allem die Zufriedenheit im Beruf essenziell – denn nur wer mit Leidenschaft und Freude arbeitet, kann langfristig erfolgreich und erfüllt sein.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-gray-700 font-medium">Entdeckungsfreude:</p>
                      <p className="text-gray-600">Neue Länder, Kulturen und Ideen zu erkunden, bereichert nicht nur mein Leben, sondern auch meine Arbeit. Diese Offenheit ermöglicht es mir, innovative Perspektiven zu entwickeln und flexibel auf die Bedürfnisse meiner Kunden einzugehen.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">Ich bin überzeugt, dass alles möglich ist, wenn man seine Ziele mit Klarheit, Mut und Überzeugung verfolgt. Diese Haltung prägt meinen Ansatz, Menschen auf ihrem Weg in die Selbstständigkeit zu begleiten.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 bg-gray-200">
                  {/* Placeholder for image */}
                  <div className="w-full h-full aspect-square bg-gradient-to-br from-blue-200 to-indigo-300 flex items-center justify-center text-gray-500">
                ...
                <div className="md:w-2/3 p-6">
                  <h4 className="text-xl font-bold text-gray-800 mb-2">Patrick Rösner - Berater</h4>
                  ...
                  <p className="text-gray-600 mb-4">
                    Patrick hat zahlreiche Gründer*innen und Unternehmen auf ihrem Weg begleitet und ihnen geholfen, fundierte Entscheidungen zu treffen sowie ihre Ziele sicher und effizient zu erreichen. Seine strategische Herangehensweise und sein Blick fürs Wesentliche machen ihn zu einem unverzichtbaren Bestandteil unseres Teams.
                  </p>
                  <a href="https://www.linkedin.com/in/patrick-r%C3%B6sner-8763031bb/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
                    LinkedIn Profil
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 bg-gray-200">
                  {/* Placeholder for image */}
                  <div className="w-full h-full aspect-square bg-gradient-to-br from-purple-200 to-pink-300 flex items-center justify-center text-gray-500">
                    <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                ...
                <div className="md:w-2/3 p-6">
                  <h4 className="text-xl font-bold text-gray-800 mb-2">Jennifer Weisheit - Beraterin</h4>
                  <p className="text-gray-600 mb-4">
                  ...
                  <a href="https://www.linkedin.com/in/jennifer-weisheit/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
                    LinkedIn Profil
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12 text-gray-800">Kooperationspartner</h3>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <a href="https://institut-weisheit.de/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <span className="text-xl font-medium text-gray-800 hover:text-indigo-600 transition-colors">Institut Weisheit</span>
                </div>
              </a>
            </div>
            
            <div className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <a href="https://starthilfe-marketing.de/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center h-full">
                <div className="text-center">
                  <div className="bg-white rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-sm">
                    <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-xl font-medium text-gray-800 hover:text-blue-600 transition-colors">Starthilfe Marketing</span>
                </div>
              </a>
            </div>
          </div>
