...
const About = () => {
  const aboutText = {
    de: {
      ...
      title_text:
        "Weil jedes erfolgreiche Business mit der richtigen Unterstützung beginnt.",
      quote:
      ...
      box_text_second:
        "Dank unseres remote-first Ansatzes agieren wir flexibel von diversen Standorten aus und verbinden Innovation, Strategie und persönliche Beratung – stets mit einem klaren Fokus auf deine individuellen Bedürfnisse.",
      mission_title: "Unsere Mission",
      mission_text:
        "Wir begleiten Menschen auf ihrem Weg in die Selbstständigkeit und helfen ihnen, ihre beruflichen Visionen in die Realität umzusetzen. Mit persönlicher Beratung, fachlicher Expertise und individuellen Lösungen bieten wir unseren Kunden die Unterstützung, die sie für eine erfolgreiche Zukunft brauchen.",
      ...
      mission_vision_text:
        "Seit der Gründung konnten wir bereits zahlreiche Kunden erfolgreich unterstützen und sind stolz darauf, Teil ihrer Erfolgsgeschichten zu sein. ",
      mission_vision_text_second:
        "Wir arbeiten eng mit dir zusammen, um deine Herausforderungen zu meistern und nachhaltigen Erfolg zu erzielen.",
      ...
      founder_points_one_text:
        "Mein Ziel ist es, Menschen die Möglichkeit zu geben, ihr Leben selbstbestimmt zu gestalten, indem sie ihr eigenes Business erfolgreich umsetzen. Freiheit bedeutet für mich, die Kontrolle über die eigene berufliche und private Zukunft zu haben.",
      founder_points_two: "Gesundheit und Zufriedenheit im Beruf:",
      founder_points_two_text:
        "Eine bewusste und gesunde Lebensweise liegt mir am Herzen, denn sie ist die Grundlage für nachhaltigen Erfolg. Dabei ist vor allem die Zufriedenheit im Beruf essenziell – denn nur wer mit Leidenschaft und Freude arbeitet, kann langfristig erfolgreich und erfüllt sein.",
      founder_points_three: "Entdeckungsfreude:",
      founder_points_three_text:
        "Neue Länder, Kulturen und Ideen zu erkunden, bereichert nicht nur mein Leben, sondern auch meine Arbeit. Diese Offenheit ermöglicht es mir, innovative Perspektiven zu entwickeln und flexibel auf die Bedürfnisse meiner Kunden einzugehen.",
      founder_points_four: "Optimismus:",
      founder_points_four_text:
        "Ich bin überzeugt, dass alles möglich ist, wenn man seine Ziele mit Klarheit, Mut und Überzeugung verfolgt. Diese Haltung prägt meinen Ansatz, Menschen auf ihrem Weg in die Selbstständigkeit zu begleiten.",
      team_title: "Unser Team",
      team_pat_position: "- Berater -",
      team_pat_text_one:
        "Mit mehr als 10 Jahren Erfahrung in der Beratung ist Patrick Rösner eine zentrale Stütze unseres Teams. Seine umfassenden Kenntnisse und sein tiefes Verständnis für verschiedenste Wirtschaftssektoren machen ihn zu einem wertvollen Experten, vor allem in der Entwicklung von Businessplänen, der Optimierung von Geschäftsstrategien und der Analyse von Marktchancen.",
      team_pat_text_second:
        "Patrick hat zahlreiche Gründer und Unternehmen auf ihrem Weg begleitet und ihnen geholfen, fundierte Entscheidungen zu treffen sowie ihre Ziele sicher und effizient zu erreichen. Seine strategische Herangehensweise und sein Blick fürs Wesentliche machen ihn zu einem unverzichtbaren Bestandteil unseres Teams.",
      team_jen_position: "- Beraterin -",
      team_jen_text_one:
        "Jennifer Weisheit ist deine kompetente Begleiterin auf dem Weg zur erfolgreichen Gründung. Mit ihrer langjährigen Erfahrung als Unternehmensberaterin hat sie bereits zahlreiche Gründer:innen auf ihrem Weg zum Erfolg unterstützt.",
      team_jen_text_second:
        "Nach wertvollen Jahren als angestellte Beraterin entschied sie sich, selbst den Schritt in die Selbstständigkeit zu wagen – ein Weg, der sie geprägt und bereichert hat. Heute nutzt sie ihre umfassende Expertise, um Gründer:innen dabei zu helfen, ihre Vorhaben sicher und gewinnbringend umzusetzen.",
      team_jen_text_third:
        "Jennifer legt großen Wert darauf, dir nicht nur praktische Werkzeuge und Strategien an die Hand zu geben, sondern dich auch mental auf die Herausforderungen und Chancen des Unternehmertums vorzubereiten.",
      cooperation_title: "Kooperationspartner",
      cooperation_text:
        "Wir freuen uns, dir die mit AS Vision Partners verbundenen Kooperationspartner vorzustellen. Durch diese langjährige, professionelle Zusammenarbeit werden optimale Voraussetzungen für die jungen Unternehmer von morgen geschaffen.",
    },
    en: {
      title: "About Us",
      upper_title: "our team",
      title_text:
        "Because every successful business starts with the right support.",
      quote: "Daily we support numerous entrepreneurs across Germany",
      second_title: "About Us",
      lower_second_title: "AS Vision Partners",
      second_title_text:
        "Business consulting for start-ups and established companies",
      box_text_first:
        "As a strategic network of closely connected partners, we have made it our mission to support founders, start-ups and self-employed individuals in realizing their visions and turning their dreams into reality.",
      box_text_second:
        "Thanks to our remote-first approach, we operate flexibly from various locations, combining innovation, strategy and personal consulting - always with a clear focus on your individual needs.",
      mission_title: "Our Mission",
      mission_text:
        "We accompany people on their path to self-employment and help them turn their professional visions into reality. With personal advice, professional expertise and individual solutions, we offer our customers the support they need for a successful future.",
      vision_title: "Our Vision",
      vision_text:
        "We want to be a central point of contact for founders and entrepreneurs looking for clear orientation, practical support and long-term success. Our vision is to create a network where everyone has the opportunity to realize their professional dreams with a clear strategy and sustainable solutions.",

      mission_vision_text:
        "Since our founding, we have already successfully supported numerous clients and are proud to be part of their success stories.",
      mission_vision_text_second:
        "We work closely with you to overcome your challenges and achieve sustainable success.",
      ...
      third_title_subtitle_three_text:
        "For a business ready to grow to the next level.",
      founder_title: "Meet the Founder - Anna Schenk",
      ...
      founder_points_one_text:
        "My goal is to give people the opportunity to shape their lives autonomously by successfully implementing their own business. To me, freedom means having control over one's professional and personal future.",
      founder_points_two: "Health and job satisfaction:",
      founder_points_two_text:
        "A conscious and healthy lifestyle is important to me as it's the foundation for sustainable success. Job satisfaction is particularly essential - because only those who work with passion and joy can be successful and fulfilled in the long term.",
      founder_points_three: "Love of discovery:",
      founder_points_three_text:
        "Exploring new countries, cultures and ideas enriches not only my life but also my work. This openness allows me to develop innovative perspectives and respond flexibly to my clients' needs.",
      founder_points_four: "Optimism:",
      founder_points_four_text:
        "I'm convinced that anything is possible if you pursue your goals with clarity, courage and conviction. This attitude shapes my approach to accompanying people on their path to self-employment.",
      team_title: "Our Team",
      team_pat_position: "- Consultant -",
      team_pat_text_one:
        "With over 10 years of consulting experience, Patrick Rösner is a central pillar of our team. His comprehensive knowledge and deep understanding of various economic sectors make him a valuable expert, particularly in business plan development, business strategy optimization and market opportunity analysis.",
      team_pat_text_second:
        "Patrick has accompanied numerous founders and companies on their journey, helping them make informed decisions and achieve their goals safely and efficiently. His strategic approach and eye for what matters make him an indispensable part of our team.",
      team_jen_position: "- Consultant -",
      team_jen_text_one:
        "Jennifer Weisheit is your competent companion on the path to successful founding. With her many years of experience as a business consultant, she has already supported numerous founders on their path to success.",
      team_jen_text_second:
        "After valuable years as an employed consultant, she decided to take the step into self-employment - a path that has shaped and enriched her. Today she uses her comprehensive expertise to help founders implement their projects safely and profitably.",
      team_jen_text_third:
        "Jennifer places great emphasis on not only providing you with practical tools and strategies, but also mentally preparing you for the challenges and opportunities of entrepreneurship.",
      cooperation_title: "Cooperation Partners",
      cooperation_text:
        "We are pleased to introduce you to the cooperation partners associated with AS Vision Partners. Through these long-standing, professional collaborations, we create optimal conditions for tomorrow's young entrepreneurs.",
    },
  };
      ...
      <div className="bg-gray-50 min-h-screen text-justify">
        ...
        <section className=" px-8 sm:px-6 lg:px-8 bg-white">
          ...
          <div className="max-w-7xl mx-auto mt-6 mb-10 text-justify md:text-center px-8 lg:px-16">
            <p className="text-lg text-gray-700 ">{t.mission_vision_text}</p>
