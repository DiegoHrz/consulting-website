    ...
    <div className="">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-xl p-8 mb-12 text-white">
        ...
        <p className="text-lg">
          ...
          ansprechende Website und eine durchdachte Marketingstrategie sind
          heute unverzichtbar, um Kunden zu erreichen und zu begeistern.
        </p>
        <p className="text-lg">
          Wir unterstützen dich dabei, deine Marke professionell zu präsentieren
          und mit gezielten Maßnahmen deine Zielgruppe anzusprechen.
        </p>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="mb-12">
          <div className="flex flex-col md:flex-row gap-8 mb-8">
            <div className="md:w-1/3">
              <h3 className="text-xl font-bold mb-4 text-indigo-700">
                Websites – Dein professioneller Online-Auftritt
              </h3>
            ...
            <div className="md:w-2/3">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-indigo-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    Gemeinsam besprechen wir deine Ziele, Zielgruppe und
                ...
                <div className="bg-indigo-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    Ästhetisches, benutzerfreundliches und responsives Design
                    für alle Geräte.
                  </p>
                </div>
                <div className="bg-indigo-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    Erfahrene Programmierer setzen deine Website mit modernsten
                    Technologien um.
                  </p>
                </div>
                <div className="bg-indigo-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    Spezielle Seiten gezielt auf Kampagnen oder Angebote
                    abgestimmt.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-indigo-100 shadow-sm">
            ...
            <p className="text-gray-700">
              Auch nach der Fertigstellung deiner Website stehen wir dir bei
              technischen Fragen und Updates zur Seite.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          <h3 className="text-xl font-bold mb-4 text-indigo-700">
            Marketing – Werde sichtbar, wo es zählt
          </h3>
          <p className="text-gray-700 mb-6">
            Wir sorgen dafür, dass deine Botschaft ankommt und deine Marke bei
            der richtigen Zielgruppe wahrgenommen wird:
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-indigo-50 p-4 rounded-lg min-h-[180px] flex flex-col">
              ...
              <p className="text-gray-700 text-sm flex-grow">
                Effektive Anzeigenkampagnen für mehr Reichweite und
                Sichtbarkeit.
              </p>
            </div>
            ...
            <div className="bg-indigo-50 p-4 rounded-lg min-h-[180px] flex flex-col">
              ...
              <p className="text-gray-700 text-sm flex-grow">
                Durchgängiges Erscheinungsbild für eine professionelle und
                einprägsame Marke.
              </p>
            </div>
            ...
            <div className="bg-indigo-50 p-4 rounded-lg min-h-[180px] flex flex-col">
              ...
              <p className="text-gray-700 text-sm flex-grow">
                Präsenz auf den richtigen Plattformen mit kreativen,
                zielgerichteten Inhalten.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Wir analysieren deine Zielgruppe, Wettbewerber und
                Marktposition, um eine maßgeschneiderte Strategie zu entwickeln.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Erstellung eines stimmigen Konzepts mit modernem Design, das
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Professionelle technische Umsetzung mit Fokus auf
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Erfolgreicher Start begleitet von gezielten Marketingmaßnahmen
      ...
      {/* <div className="bg-indigo-100 rounded-xl p-8 text-center">
        <h3 className="text-xl font-bold mb-4">
          Bereit für deinen professionellen Online-Auftritt?
        </h3>
        <p className="mb-6">
      ...
      <div className="my-20 md:my-36"> 
        <AppointmentBanner gradientColor="from-indigo-900"  gradientColor2="to-indigo-100" buttonColor="bg-indigo-600" />
      </div>
