    ...
    <div className="  h-full flex flex-col gap-[80px] md:gap-[150px]  lg:gap-[180px] ">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-10">
          <div className="w-full lg:w-[60%]">
            <p className="text-lg py-4 text-justify">
              Ein Businessplan ist mehr als nur ein Dokument – er ist der
              Kompass für deine Selbstständigkeit. Er zeigt dir nicht nur, wohin
              du willst, sondern auch, wie du dorthin gelangst. Gleichzeitig dient er als überzeugendes Werkzeug, um Partner,
              Banken und Investoren von deiner Idee zu begeistern.
            </p>
          </div>
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-700 mb-4">
          ...
          Entscheidungen – sowohl für dich selbst als auch für externe Partner.
          Er hilft dir:
        </p>
